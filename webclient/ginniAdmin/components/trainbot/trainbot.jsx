...
export default class TrainBot extends React.Component {
    ...
    setSameAsIntents(baseIntent, intents) {
        ...
        console.log("inside SetSame");
        this.setState({sameAsIntentsDisplay: sameAsIntentsDisplay, baseIntent: baseIntent});
        localStorage.setItem("query", "match (n)-[r]->(m:intent) where m.name='" + baseIntent + "' return n,r,m");
        this.setState({graph: <p></p>});
        this.setState({graph: <frameset>
                <frame src='http://localhost:8080/graphie'/>
            </frameset>});
    }
    ...
    componentWillMount() {
        localStorage.setItem("query", "match (n:intent) return n");
    }
                    ...
                    <Grid.Column width={6}>
                        ...
                        <Grid.Row>
                            <a>
                                ...
                                ? <NewIntentText open={this.handleclose}/>
                                : null}
                        </Grid.Row>
                        <br/><br/>
                        <Grid.Row>
