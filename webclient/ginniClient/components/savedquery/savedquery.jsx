...
export default class SavedQuery extends React.Component {
  ...
  return (
 <div>
    <Card fluid style={{background: '#F1F8E9', borderStyle: 'solid',
      borderWidth: 'thin', borderColor: 'teal'}}>
      <Card.Content >
      <h4>{newsdata.date}</h4>
      <Card.Description style={{color: 'black'}}>
      {newsdata.answer}
      <Popup positioning='left center' offset={5} inverted size='mini'
        trigger={<Label onClick={() => this.deletesavequery(newsdata._id)}
          corner='right' size='mini' icon='delete' />} content='Delete'/>
      </Card.Description>
        </Card.Content>
    </Card>
    <br/>
