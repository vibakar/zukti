                ...
                <Feed id="ginniview">
                    <Feed.Event>
                        <Feed.Content id='ginniviewKeyword'>
                            <Feed.Summary>
                                <UnfurlLink url ={video}/></Feed.Summary>
                            <Feed.Extra>
                                <Label.Group>
                                    {this.props.data.video.length - 1 > 0
                                        ? <Label onClick={this.displayMoreVideos} basic color='orange' id='cursor'>View More Videos</Label>
                                        : ''}
                                    {this.props.data.blog
                                        ? <Label onClick={this.displayBlogs} basic color='orange' id='cursor'>Blogs</Label>
                                        : ''}
                                    <Modal closeOnRootNodeClick={false} closeIcon='close' trigger= {<Label onClick={this.playVideo
                                }
                                basic color = 'orange' id = 'cursor' > Play video < /Label>}>
                                    ...
                                    <AssistantGinniOptions question={this.props.question} type='blog' value={video}/>
                                </Label.Group>
                            </Feed.Extra>
                        </Feed.Content>
                    </Feed.Event>
            ...
            return (
                <Feed id="ginniview">
                    <Feed.Event>
                        <Feed.Content id='ginniviewKeyword'>
                            <Feed.Summary>
                                <UnfurlLink url ={blog}/></Feed.Summary>
                            <Feed.Extra>
                                <Label.Group>
