...
module.exports = function(app, passport) {
    ...
    // login - username all details should be sent to passport and some data will be stored in cookies
    ...
    app.post('/send', function handleSayHello(req, res) {
        ...
        RegisteredUser.find({
            ...
            if (err) {
                ...
                // bcrypt- to keep the user details secured
